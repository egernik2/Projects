...
class MainWindow(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry_month = customtkinter.CTkEntry(self, width = 150)
        self.entry_month.grid(column=1, row=6, sticky='n', padx=10, pady=140)
        self.entry_day = customtkinter.CTkEntry(self, width = 150)
    ...
    def insert_data(self):
        try:
            self.query_data = self.entry_year.get() + '-' + self.entry_month.get() + '-' + self.entry_day.get()
...
class Monitoring(customtkinter.CTk):
    def __init__(self, cur1, cur2, conn1, conn2):
        super().__init__()
        self.cur1 = cur1
        self.cur2 = cur2
        self.conn1 = conn1
    ...
    def query(self):
        while True:
            try:
                for query_data in self.insert_data:
...
def main():
    ...
    if mainwindow.conn1 and mainwindow.conn2:
        ...
        monitoring_window = Monitoring(cur1, cur2, conn1, conn2)
